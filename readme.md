...
By default, OSARA will report the name of a single note or number of notes in a chord, then the new cursor position.
Reporting of note names and position can both be disabled in OSARA configuration.
